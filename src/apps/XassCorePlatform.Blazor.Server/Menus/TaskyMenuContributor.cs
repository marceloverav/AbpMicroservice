...
namespace XassCorePlatform.Blazor.Server.Menus;

public class XassCorePlatformMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public XassCorePlatformMenuContributor(IConfiguration configuration)
    {
